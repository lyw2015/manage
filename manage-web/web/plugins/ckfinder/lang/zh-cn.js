...
CKFinder.lang['zh-cn'] =
{
	...
	FilesDelete	: '您确定要删除 %1 个文件吗?', // MISSING
	FilesLoading	: '加载中...',
	FilesEmpty		: '空文件夹',
	...
	// Move and Copy files
	MovedFilesNumber		: '移动的文件数: %s.', // MISSING
	CopiedFilesNumber	: '复制的文件数: %s.', // MISSING
	MoveFailedList		: '无法移动以下文件:<br />%s', // MISSING
	CopyFailedList		: '无法复制以下文件:<br />%s', // MISSING
